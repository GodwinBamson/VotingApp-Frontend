...
//     if (Array.isArray(voterElections) && voterElections.includes(selectedElection)) {
//       setCanVote(false);
//     }
      ...
      <section className="candidates">
        {!canVote ? (
          <header className="candidates_header">
            <h1>Already voted</h1>
            <p>
              You are only permitted to vote once in this election. Please vote in another election or sign out.
            </p>
          </header>
        ) : candidates.length === 0 ? (
          <header className="candidates_header">
