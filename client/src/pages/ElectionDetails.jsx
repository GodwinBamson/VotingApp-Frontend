...
//         // `${import.meta.env.VITE_API_URL}/api/elections/${id}`,
...
//     try {
//       const response = await axios.get(
//         // `${import.meta.env.VITE_API_URL}/api/elections/${id}/voters`,
...
//     try {
//       // await axios.delete(`${import.meta.env.VITE_API_URL}/api/elections/${id}`,
...
//   const getCandidates = async () => {
//     try {
//       const response = await axios.get(`${BASE_URL}/elections/${id}/candidates`, {
//         withCredentials: true,
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       setCandidates(response.data);
...
//   const getVoters = async () => {
//     try {
//       const response = await axios.get(`${BASE_URL}/elections/${id}/voters`, {
//         withCredentials: true,
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       setVoters(response.data);
...
//       navigate("/elections");
//     } catch (error) {
//       console.log("Failed to delete election:", error);
//     }
//   };
      ...
      <section className="electionDetails">
        <div className="container electionDetails_container">
          ...
          <div className="electionDetails_image">
            <img
              src={
                elections.thumbnail?.startsWith("http")
                  ? elections.thumbnail
                  : `${BASE_URL}/${elections.thumbnail}`
              }
              alt={elections.title}
            />
          </div>
